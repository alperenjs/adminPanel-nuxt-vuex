...
<div class="container-fluid">
  <div class="px-lg-5">
    ...
    <div class="upload-image-row row py-5">
        ...
        <UploadImage   @uploadImage="emitUrlfromComponent($event)"
              ref="uploadImage" />
    </div>
    <div class="row py-5">
    ...
    <div class="row">
      <!-- Gallery item -->
      <div :id="photo.id"  v-for="photo in photos.slice().reverse()" :key="photo.id"  class="col-xl-3 col-lg-4 col-md-6 mb-4 photo-div">
        <div class="bg-white rounded shadow-sm"><img :id="`img` + photo.id" class="galeri-photo" :src="photo.img_url" alt="galeri foto">
           <div class="p-4">
            <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
              <p class="small mb-0"><i class="fa fa-picture-o mr-2"></i><span class="font-weight-bold">Boyut: {{ photo.size }}</span></p>
              <div @click="deleteImg(photo.id, photo.key)" class="delete-btn badge badge-danger px-3 rounded-pill font-weight-normal">Sil</div>
            </div>
          </div>
        </div>
      </div>
