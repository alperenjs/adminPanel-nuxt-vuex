        ...
        <form>
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-3 col-12">
                ...
                <button
                  v-show="downloadedImgURL != null"
                  @click="removeImage"
                  class="btn btn-danger delete-blog-cover-pic"
                  style="display: none"
                >
                  Resim Kaldır
                </button>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-5 col-6">
                <span class="form-text text-muted"
                  >Daha önce yüklediğiniz resimlerden seçin.</span
                >
                <ImageGallery
              ...
              <div class="col-md-5 col-6">
                <span class="form-text text-muted"
                  >Bilgisayarınızdan yeni resim yükleyin.</span
                >
                <UploadImage
            ...
            <div class="form-group row">
              ...
              >
              <div class="col-md-10 col-12">
                <Texteditor @uploadText="emitTextfromComponent($event)" />
              </div>
            </div>
            <div class="form-group row">
              <label class="col-md-2 col-12 col-form-label"
                >SEO için Etiketler</label
              >
              <div class="col-md-10 col-12 tagger-container">
                ...
                <span class="form-text text-muted"
                  >İlgili etiketler, içeriğin Google tarafından öne
                  çıkarılmasında yardımcı olur.</span
                >
              </div>
            </div>
          </div>
          <div class="card-footer">
            <div class="row">
              ...
              <div class="col-md-10 col-12">
                ...
                <span class="form-text text-muted"
                  >Google aramalarda, sayfa başlığının altında gözükecek olan
                  bilgilendirici açıklama.</span
                >
              </div>
            </div>
          </div>
        </form>
        <button @click="updatePost(blogID)" class="btn btn-success mr-2 w-100">
          Güncelle
        </button>
      </div>
    </div>
